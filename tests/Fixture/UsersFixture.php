...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'usuarios_empresa_id_fk' => ['type' => 'index', 'columns' => ['empresa_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'usuarios_empresa_id_fk' => ['type' => 'foreign', 'columns' => ['empresa_id'], 'references' => ['empresas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'empresa_id' => 1,
            'created' => '2016-06-04 17:34:34',
            'modified' => '2016-06-04 17:34:34'
        ],
    ];
}
