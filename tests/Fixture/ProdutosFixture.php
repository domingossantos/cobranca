...
class ProdutosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'descricao' => ['type' => 'string', 'length' => 250, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'produtos_empresa_id_fk' => ['type' => 'index', 'columns' => ['empresa_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'produtos_empresa_id_fk' => ['type' => 'foreign', 'columns' => ['empresa_id'], 'references' => ['empresas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'empresa_id' => 1,
            'created' => '2016-06-04 19:02:57',
            'modified' => '2016-06-04 19:02:57'
        ],
    ];
}
